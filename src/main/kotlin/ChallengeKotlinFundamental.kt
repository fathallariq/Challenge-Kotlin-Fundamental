/* fun main () {}
fun rectangular_vol(length: Double, width: Double, height: Double): Double {}
fun bal_vol(rad: Double): Double {}
fun cone_vol(rad: Double, height: Double): Double {}
fun cylinder_vol(rad: Double, height: Double): Double{} */
...
fun main() {
    ...
    val emailLength = email?.length ?:"emailny apaya"
    println(emailLength)
    println("====================================");
    menu()
}
